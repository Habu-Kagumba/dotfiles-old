...
files="ctags web_utils.sh ackrc bash_profile bashrc vimrc vimrc.local vimrc.local.bundles tmux.conf zshrc oh-my-zsh tmuxline.conf"    # list of files/folders to symlink in homedir
